...
struct CharacterPreviewView: View {
    let store: StoreOf<CharacterPreviewViewModel>

    init(character: ResultModelEntity) {
        self.store = Store(initialState: CharacterPreviewViewModel.State(character: character, entiryState: .init(id: character.id, isSeen: false, isLiked: false))) {
